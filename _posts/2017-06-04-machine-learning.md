...
Because we collectively had limited experience with convolutional neural networks, we decided to first explore the hyperparameters of a CNN. We did so by creating a 108-dimensional experiment in which we varied the kernel size and number of filters of each convolutional layer and the dropout rate. For this study, we kept a constant network architecture.
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        <tr style="text-align: left">
          <td>Kernel Size (Conv Layer 1)</td>
          <td>3x3, 5x5, 7x7</td>
        </tr>
        <tr style="text-align: left">
          <td>Kernel Size (Conv Layer 2)</td>
          <td>3x3, 5x5, 7x7</td>
        </tr>
        <tr style="text-align: left">
          <td>Number of Filters (Conv Layer 1)</td>
          <td>16, 32</td>
        </tr>
        <tr style="text-align: left">
          <td>Number of Filters (Conv Layer 2)</td>
          <td>32, 64</td>
        </tr>
        <tr style="text-align: left">
          <td>Dropout Rate</td>
